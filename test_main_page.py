...
#from pages.main_page import MainPage #- at later stages we transferred class MainPage' methods into BasePage
...
def test_guest_can_go_to_login_page_from_main_page(browser):
    link = "http://selenium1py.pythonanywhere.com/"
    #page = MainPage(browser, link)
    page = BasePage(browser, link)   # инициализируем Page Object главной страницы, передаем в конструктор экземпляр
